...
const KABUK = [
  ...
  './assets/css/style.css?s=3',
  './assets/js/config.js?s=3',
  './assets/js/utils.js?s=3',
  './assets/js/kanal-firebase.js?s=3',
  './assets/js/kanal.js?s=3',
  './assets/js/arkaplan.js?s=3',
  './assets/js/muzik.js?s=3',
  './assets/js/medya.js?s=3',
  './assets/js/router.js?s=3',
  './assets/js/views/ana.js?s=3',
  './assets/js/views/yildizharitasi.js?s=3',
  './assets/js/views/duvar.js?s=3',
  './assets/js/views/kalpsenkronu.js?s=3',
  './assets/js/views/uyum.js?s=3',
  './assets/js/views/cizim.js?s=3',
  './assets/js/views/cark.js?s=3',
  './assets/js/views/gunluk.js?s=3',
  './assets/js/views/kapsul.js?s=3',
  './assets/js/views/kuponlar.js?s=3',
  './assets/js/views/sayac.js?s=3',
  './assets/js/views/tunel.js?s=3',
  './assets/js/views/mektup.js?s=3',
  './assets/js/app.js?s=3',
